<template>
  ...
  <div class="fixed inset-0 z-40 flex items-center justify-center bg-black/70 backdrop-blur-sm panel-shell" @click.self="emit('close')">
    <div class="relative w-full max-w-3xl max-h-[92vh] mx-4 bg-gradient-to-b from-[#1c1917] to-[#0c0a09] border border-indigo-900/50 rounded-2xl shadow-2xl shadow-indigo-900/30 flex flex-col panel-body">
      <!-- 头部 -->
