...
export const ACTIONS = {
  ...
  system_quest: { name: '指归', desc: '尘缘指归 任务引路', icon: svg('text-gold-400', '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/><path d="M8 7h8"/><path d="M8 11h6"/>') },
...
export const DOCK_TABS = [
  ...
  { key: 'self', label: '自身', ids: ['system_quest', 'character', 'achievement', 'announcement'] },
]
