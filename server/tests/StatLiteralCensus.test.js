...
const LEDGER = {
    ...
    'routes/admin.js:251': { verdict: 'db_columns', reason: 'GM 改玩家的**列**白名单（含 attributes 整块那一列），不是属性键白名单' },
    'routes/admin.js:561': { verdict: 'generic_block', reason: 'GM 建号初值兜底，真值来自 role_init.initialAttributes' },
